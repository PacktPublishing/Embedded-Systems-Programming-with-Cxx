...
Files related to **Example11** (Writing to SQLite database using statements)
...
Try changes to the `example_source.cpp`, build and run the project again, then analyze the generated `example_output.db`.
