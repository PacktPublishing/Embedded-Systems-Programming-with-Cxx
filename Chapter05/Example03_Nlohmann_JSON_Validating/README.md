...
Files related to **Example03** (Reading JSON using Nlohmann library, and applying proper validations)
...
Try changes to the `example_input.jso`, build and run the project again, then analyze the command line output.
